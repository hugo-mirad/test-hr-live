...
var SpanBorderColor = "#CCC";//span border color
var SpanBgColor = "#FFFFFF"; //span background color
var MonthYearColor = "#000"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#CCC"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#CCC"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#CCC"; //Background color of Saturday.
var WeekDayColor = "#CCC"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#FCEFA1"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#fff"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#999"; //color when mouse move over.
...
function RenderCssCal(bNewCal)
{
	...
	{
	    vCalHeader += "<td align='center'><select name='MonthSelector' style=\"width: 107px;\" onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
		for (i = 0; i < 12; i += 1)
		{
			if (i === Cal.Month)
			{
		...
		vCalHeader += "<td align='center'><select name='YearSelector' size='1'style=\"width: 76px;\" onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
